...
#import "WPostTableViewController.h"
#import "WPostViewController.h"


@interface WPostTableViewController ()

@property (nonatomic, strong) NSMutableArray *datas;

@end

@implementation WPostTableViewController
...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedString(@"wPostTableViewController_title", @"");
}
...
{
    WPostViewController *viewController = [[WPostViewController alloc] init];
